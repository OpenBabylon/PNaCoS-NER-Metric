...
if __name__ == '__main__':
    ...
    test_texts = [
        """людиною з характером
«Ян Таба́чник є люди́на з характéром» — популярний мем, який використовується для характеристики українського політика і бізнесмена Якова (Яна) Табачника. Використовувався в ЗМІ та соціальних мережах після того як у грудні 2018 року народні депутати від"""
    ]
