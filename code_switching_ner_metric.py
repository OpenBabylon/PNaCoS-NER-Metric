...
if __name__ == '__main__':
    ...
    test_texts = [
        """ центром Полтавської області. Вітамін B12 та E2334 
ℏ
⊥
⊤
∠ABD=90°
Зараз місто має площу 23,59 км², на якій розташовано близько 40 тисяч житлових будинків та майже мільйон мешканців.
        """
    ]
